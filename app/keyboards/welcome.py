...
def make_start() -> keyboard.InlineKeyboardMarkup:
    ...
    keyboard_builder.button(text="Регистрация", callback_data=schemas.WelcomeSchema(registration="registration"))
    keyboard_builder.button(text="Получить личную информацию", callback_data=schemas.WelcomeSchema(about_me="about_me"))
    keyboard_builder.button(text="Путешествия", callback_data=schemas.WelcomeSchema(add_travel="add_travel"))
